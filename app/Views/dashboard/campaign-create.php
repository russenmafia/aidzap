    ...
    <div class="wizard-main">
      ...
      <div class="form-section">
        ...
        <div class="form-grid">
          ...
          <div class="field full">
            <label>Countries <span style="color:rgba(255,255,255,0.25);font-weight:400">(comma separated ISO codes)</span></label>
            <input type="text" name="countries"
                   value="<?= htmlspecialchars($old['countries'] ?? '') ?>"
                   placeholder="US, DE, GB, CA — leave empty for worldwide">
          </div>
